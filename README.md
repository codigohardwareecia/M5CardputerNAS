# Servidor de arquivos NAS com o Cardputer

Abra o Arduino IDE

Clique em Preferences vá em Urls Aditicional e cole a url abaixo

Url da BoardManager para o M5Stack
https://static-cdn.m5stack.com/resource/arduino/package_m5stack_index.json

Depois vá em ManagerBoard e instale o M5Stack

Após  a instalação selecione no Board Manager logo abaixo M5Stack > Cardputer

Instale as bibliotecas de suporte vá em Include Library, digite M5Cardputer e clique em Install

Abaixo o código inicial para testarmos a funcionalidade de NAS
...
void handleRoot() {
  ...
  while(file){
    if (!file.isDirectory()) {
      ...
      if (n.endsWith(".html") || n.endsWith(".htm") || n.endsWith(".png") || n.endsWith(".mp4")) {
